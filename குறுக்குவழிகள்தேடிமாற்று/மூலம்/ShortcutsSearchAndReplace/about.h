...
#define ABOUT_SYSLINK_PROJECT_LINK _T("http://jacquelin.potier.free.fr/ShortcutsSearchAndReplace/")
#define ABOUT_SYSLINK_PROJECT_USER_DOC_LINK _T("http://jacquelin.potier.free.fr/ShortcutsSearchAndReplace/index.php#documentation_user")
#define ABOUT_SYSLINK_EMAIL_LINK _T("mailto:jacquelin.potier@free.fr")

#define ABOUT_SYSLINK_XPOS 20
#define ABOUT_SYSLINK_YPOS 80
