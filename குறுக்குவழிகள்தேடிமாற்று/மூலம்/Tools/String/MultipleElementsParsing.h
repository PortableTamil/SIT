...
{
public:
    static SIZE_T* ParseSIZE_T(TCHAR* pszText,SIZE_T* pArraySize);
    static TCHAR** ParseString(TCHAR* pszText,SIZE_T* pArraySize);
    static void   ParseStringArrayFree(TCHAR** pArray,SIZE_T ArraySize);
};
