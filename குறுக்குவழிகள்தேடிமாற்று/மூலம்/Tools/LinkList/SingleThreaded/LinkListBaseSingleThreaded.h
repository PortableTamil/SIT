...
public:
    ...
    virtual BOOL MoveItemTo(CLinkListItem* pItem,CLinkListItem* PreviousItem);
    virtual BOOL MoveItemToHead(CLinkListItem* pItem);
    virtual BOOL MoveItemToTail(CLinkListItem* pItem);
    ...
    SIZE_T GetNumberOfItemsBeforeItem(IN CLinkListItem* pItem);
    SIZE_T GetNumberOfItemsAfterItem(IN CLinkListItem* pItem);
    PVOID* ToArray(SIZE_T* pdwArraySize);

    BOOL IsEmpty();
    BOOL IsItemStillInList(CLinkListItem* pItem);
    BOOL IsItemDataStillInList(PVOID pItemData);
    CLinkListItem* GetItem(SIZE_T ItemIndex);
