...
public:
    ...
    virtual CLinkListItem* AddEmptyItem();
    virtual CLinkListItem* AddEmptyItem(BOOL bUserManagesLock);
    ...
    virtual BOOL RemoveItem(CLinkListItem* Item,BOOL bUserManagesLock=FALSE);
    virtual BOOL RemoveItemFromItemData(PVOID ItemData,BOOL bUserManagesLock=FALSE);
    virtual BOOL RemoveAllItems(BOOL bUserManagesLock=FALSE);
};
