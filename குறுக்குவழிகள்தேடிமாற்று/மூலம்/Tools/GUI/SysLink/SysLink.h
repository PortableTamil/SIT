...
private:
    ...
    void Initialize(HWND hWndParent,int ControlID,LPCWSTR Text,int XPos,int YPos,int Width,int Height,BOOL bVisible);
public:
    
    CSysLink(HWND hWndParent,int ControlID,LPCSTR Text,int XPos,int YPos,int Width,int Height,BOOL bVisible = TRUE);
    CSysLink(HWND hWndParent,int ControlID,LPCWSTR Text,int XPos,int YPos,int Width,int Height,BOOL bVisible = TRUE);
    ~CSysLink(void);
